...
def check():
     ...
     b9=bt9["text"];
     flag=flag+1;
     if b1==b2 and b1==b3 and b1=="0" or b1==b2 and b1==b3 and b1=="x":
         win(bt1["text"])
     if b4==b5 and b4==b6 and b4=="0" or b4==b5 and b4==b6 and b4=="x":
         win(bt4["text"])
     if b7==b8 and b7==b9 and b7=="0" or b7==b8 and b7==b9 and b7=="x":
         win(bt7["text"]) 
     if b1==b4 and b1==b7 and b1=="0" or b1==b4 and b1==b7 and b1=="x":
         win(bt1["text"])
     if b5==b2 and b2==b8 and b2=="0" or b5==b2 and b2==b8 and b2=="x":
         win(bt2["text"])
     if b3==b5 and b5==b9 and b3=="0" or b3==b5 and b3==b9 and b3=="x":
         win(bt3["text"])
     if b1==b5 and b1==b9 and b1=="0" or b1==b5 and b1==b9 and b1=="x":
         win(bt1["text"])
     if b3==b5 and b3==b7 and b3=="0" or b3==b5 and b3==b7 and b3=="x":
         win(bt3["text"])
     if flag==10:
...
def win(player):
    end="game complete" + player +"wins"
    messagebox.showinfo("congragulations",ans)
    window.destroy()
